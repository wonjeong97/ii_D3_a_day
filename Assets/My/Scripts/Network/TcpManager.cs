...
namespace My.Scripts.Network
{
    ...
    public class TcpManager : MonoBehaviour
    {
        ...
        private void InitializeNetwork()
        {
            ...
            {
                Debug.LogWarning("[TcpManager] TcpSetting.json 로드 실패. 기본 설정(127.0.0.1:7777)으로 진행합니다.");
                loadedSetting = new TcpSetting { isServer = true, serverIP = "127.0.0.1", port = 7777 };
            }
